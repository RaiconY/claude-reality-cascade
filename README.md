...
| Параметр | Sonnet 4 | Opus 4 | Sonnet 3.7 | OpenAI Codex |
|----------|----------|--------|-------------|---------------|
| **Размер файла** | 33KB | 40KB | 21KB | **5KB** |
| **Строк кода** | ~570 | ~680 | ~350 | **~120** |
| **CSS подход** | Базовые fadeIn | Продвинутые transitions | Минимальные hover | Элегантные анимации |
| **JS архитектура** | Объектно-ориентированный | Модульный подход | Функциональный | **Современный ES6+** |
| **Мобильная адаптация** | ✅ 3 брейкпоинта | ✅ Responsive grid | ✅ Базовая адаптация | ✅ CSS Grid |
| **Интерактивность** | Средняя | Высокая | Низкая | **Мгновенная** |
...
**Модели:** Claude Sonnet 4, Claude Opus 4, Claude Sonnet 3.7, OpenAI Codex  
**Дата:** Июнь 2025
